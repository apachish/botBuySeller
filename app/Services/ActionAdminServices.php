    ...
    public function actionText()
    {
        ...
        switch ($this->getMessage()) {
            ...
            case "\xE2\x98\x81تعطیل/باز":
                ...
                break;
            case "\xF0\x9F\x93\x81ارسال فایل":
                $this->getTelegramServices()->sendMessage($this->getUserId(), "فایل خود را برای استا در کانال بارگذاری کنید");
                cache()->set($this->getKeyCache() . $this->getUserId(), "file");
