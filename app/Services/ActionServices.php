...
//            $message .= "حداکثر با تلرانس ۲۰۰۰ تومان لفظ دهید \n\n";
            ...
            $none = Carbon::create($time->year, $time->month, $time->day, 16, 30, 0); //set time to 18:00
            $none_13_30 = Carbon::create($time->year, $time->month, $time->day, 16, 30, 0); //set time to 18:00
            logger("check day", [
