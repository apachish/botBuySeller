            ...
            try {
                ...
                if ($this->getUser()->role == "customer") {
                    ...
                    if ($head && $head->userTradeAccess) {
                        ...
                        logger("access_limit",[$access_limit]);
                        if ($access_limit)
...
//            $message .= "حداکثر با تلرانس ۲۰۰۰ تومان لفظ دهید \n\n";
            ...
            $none = Carbon::create($time->year, $time->month, $time->day, 16, 00, 0); //set time to 18:00
            $none_13_30 = Carbon::create($time->year, $time->month, $time->day, 15, 30, 0); //set time to 18:00
            logger("check day", [
