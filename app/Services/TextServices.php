...
class TextServices
{
    ...
    protected $list_type_buy = [
        "خفپ", "خفم", "خفش", "خفن", "خش", "خن", "خم", "خف", "خپ", "خ",
        "خفپط", "خفمط", "خفشط",  "خشط",  "خمط", "خپط",
    ];
    protected $list_type_sell = [
        "ففپ", "ففم", "ففش", "ففن", "فش", "فن", "فم", "فف", "فپ", "ف",
        "ففپط","ففمط","ففشط","فشط","فمط","فپط",
    ];
    ...
    protected $list_type_today_r_f = ["خش", "خم", "فش", "فم","خپ","فپ","خشط", "خمط", "فشط", "فمط","خپط","فپط"];
    protected $list_type_today_normal = ["خ", "ف"];
    protected $list_type_today_cache = ["خن", "فن"];
    protected $list_type_tommarow = ["خف", "خفش", "خفن", "خفم", "فف", "ففش", "ففن", "ففم","خفپ", "ففپ"];
