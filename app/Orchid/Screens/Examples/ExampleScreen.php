...
class ExampleScreen extends Screen
{
    ...
    {
        $array_label = ['8:30am-10am', '10am-12pm', '12pm-14pm', '14pm-16pm', '16pm-18pm', '18pm-20pm', '20pm-22pm','22pm-24pm'];
        return [
            'charts'  => [
                [
                    'name'   => 'با حواله عادی',
...
//                ->icon('bs.window'),
    ...
    public function layout(): iterable
    {
        return [
            Layout::metrics([
                'مجموع معاملات امروز'    => 'metrics.sales',
                'پیام امروز' => 'metrics.visitors',
                'تعداد معامله' => 'metrics.orders',
                'تعداد مشتری داری معامله امروز' => 'metrics.total',
            ]),

            Layout::columns([
                ChartLineExample::make('charts', 'نمودار معامات')
                    ->description('نمایش معاملات در نوع مختلف'),
            ...
            Layout::columns([
                ...
                ChartBarExample::make('charts', 'نمودار پیام ها')
                    ->description('نمودار پیام ها در نوع مختلف'),
            ]),
